...
import postimg from "../../public/images/postpic.jpg";
      ...
      <div>
        <div className="flex flex-col mt-4 mb-2">
          <div className="w-full flex  ">
            <p className="text-sm text-center mr-4 ml-4">
              여기에 100자 미만의 줄글을 넣으세요 여기에 100자 미만의 줄글을
              넣으세요 여기에 100자 미만의 줄글을 넣으세요
            </p>
          </div>
