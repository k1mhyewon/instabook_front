            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <div>
                  ...
                  <textarea
                    id="editor"
                    className="bg-gray-50  border border-gray-300 block w-full h-20 px-0 resize rounded-lg text text-gray-800 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
